const submitHandler = (event) => {
  //When the event handler is invoked, it will:
  //1. Not refresh the page;
  event.preventDefault();

  //2. Validate the form;
  //1st construct the form's data using FormData object
...
//  3. Select one of the <input> elements and use the value property;
//  to get data.
//  const parkName = document.querySelector("#name-input").value;
//  console.log(parkName);

// the keys are the names of form's <input> elements;
